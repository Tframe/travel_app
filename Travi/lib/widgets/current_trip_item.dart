...
class _CurrentTripItemState extends State<CurrentTripItem> {
  ...
  Widget build(BuildContext context) {
    ...
    //Returns a list of countries for trip
    List<Widget> listCountries() {
      List<Widget> textList = [];
      //If there are no countries, skip displaying text
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    //If it is current, then set text current, otherwise days left
                                    widget.foundTrip.startDate
