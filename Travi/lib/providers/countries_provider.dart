...
class Countries extends ChangeNotifier {
  ...
  Future<void> addDestination(Country destinationValues) async {
    try {
      ...
      final newDestination = Country(
        ...
        country: destinationValues.country,
        latitude: destinationValues.latitude,
        longitude: destinationValues.longitude,
      );
